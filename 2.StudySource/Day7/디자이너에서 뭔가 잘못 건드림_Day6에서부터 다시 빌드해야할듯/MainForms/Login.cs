    ...
    public partial class Login : Form
    {
        ...
        private void btnLogIn_Click(object sender = null, EventArgs e = null)
        {
            ...
            try
            {
                ...
                //    string sUserName = dtTemp1.Rows[0]["USERNAME"].ToString();
                ...
                string sSql = $" SELECT USERID,USERNAME, PW, ISNULL(COUNT,0) AS COUNT FROM TB_USER WHERE USERID = '{sUserId}'";
                ...
                else if (sPassword != dtTemp.Rows[0]["PW"].ToString())
                {
                    ...
                    // 지금 현재까지 실패한 로그인 횟수.
                    int iLofingFalilCnt = Convert.ToInt32(dtTemp.Rows[0]["COUNT"]) + 1;
