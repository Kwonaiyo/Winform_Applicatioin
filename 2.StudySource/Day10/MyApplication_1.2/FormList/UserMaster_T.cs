...
namespace FormList
{
    public partial class UserMaster_T : Services.BaseChildForm
    {
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                DataTable dttemp = helper.FillTable("SP_UserMaster_S1", CommandType.StoredProcedure,
                                                   helper.CreateParameters("@USERID", txtUserId.Text),
        ...
        public override void DoDelete()
        {
            ...
            Grid1.Rows.Remove(Grid1.Rows[iIndex]);
        }
                    ...
                    switch(dr.RowState)
                    {
                        ...
                        case DataRowState.Added:        // 행이 추가된경우
                            ...
                            helper.ExecuteNonQuery("SP_UserMaster_I1", CommandType.StoredProcedure
                                                  ...
                                                  , helper.CreateParameters("@COUNT"   , Convert.ToString((dr["COUNT"]) == "" ? 0 : dr["COUNT"]))
